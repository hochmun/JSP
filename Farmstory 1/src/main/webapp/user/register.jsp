...
<script src="/Farmstory_1/js/validation.js"></script>
<script src="/Farmstory_1/js/zipcode.js"></script>
<main id="user">
    <section class="register">
        <form action="/Farmstory_1/user/proc/registerProc.jsp" method="post">
            <table>
